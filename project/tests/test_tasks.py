...
class AllTests(unittest.TestCase):
  ...
  def test_logged_in_users_can_access_tasks_page(self):
    self.register('kennedy', 'kennedy@hotmail.com', 'kennedy', 'kennedy')
    self.login('kennedy', 'kennedy')
  ...
  def test_users_can_add_tasks(self):
    self.create_user('kennedy', 'kennedy@hotmail.com', 'kennedy')
    self.login('kennedy', 'kennedy')
  ...
  def test_task_template_displays_logged_in_user_name(self):
    self.register(
        'kennedy', 'kennedy@hotmail.com', 'kennedy', 'kennedy'
      )
    self.login('kennedy', 'kennedy')
    response = self.app.get('tasks/', follow_redirects=True)
    self.assertIn(b'kennedy', response.data)
  ...
  def test_users_cannot_see_task_modify_links_for_tasks_not_created_by_them(self):
    ...
    self.create_task()
    self.logout()
    self.register('Martin', 'martin@hotmail.com', 'martin1', 'martin1')
    response = self.login('Martin', 'martin1')
    self.app.get('tasks/', follow_redirects=True)
